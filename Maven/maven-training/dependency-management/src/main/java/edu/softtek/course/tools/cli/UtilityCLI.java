package edu.softtek.course.tools.cli;
...
import edu.softtek.course.tools.DateDifferenceExample;
...
public class UtilityCLI {
    ...
    public void runDiff(DiffCommand diffCommand) {
        ...
        for (DateDifferenceExample.Dates item : DateDifferenceExample.Dates.values()) {
