...
public class FileBufferedStreamResourceTest {
	...
	public void setup() {
		...
		targetPath.append("/copy/JavaAcademy-Collections.pptx");
	...
	public void shouldCopyFileByBufferStream() {
		...
		sourcePath.append("/AdvancedJava-master/collections/doc/JavaAcademy-Collections.pptx");

		StringBuilder targetPath = new StringBuilder();
		targetPath.append(basePath);
		targetPath.append("/copy/Collection-COPY.pptx");
